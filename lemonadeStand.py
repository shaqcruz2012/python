...
class _MenuItem:
    def __init__(self, name, wholesaleCost, sellPrice):
        self.__name = name
...
class _LemonadeStand:
    ...
    def add_menu_item(MenuItem):
        return #add menu to dictionary
    def enter_sales_for_today(itemSold,howMany)
        return # if item doesnt appear in the ditionary then no sales; if the name of any time sold doesn't match the name of any MenuItem

# pause here SC 1/20/2023 7:16 PM
